...
//! with the same name as the project. In either case, does case-insensitive matching/
//
//! The file it matches will be installed with whatever casing it has in the archive file. So if a
//! project is named "SomeProject" and it releases a tarball that contains a "someproject"
//! executable, `ubi` will find it and install it with that name.
//
